...
| D-28 | Tombol fitur fase berikutnya | Tombol yang fasenya belum dibuat tetap tampil sesuai aturan tampilnya; saat diketuk menampilkan pesan "dibuat di Fase N". Status setelah Fase 5: Gajian, Pemasukan, Pakai Tabungan, Tutup Buku, dan notifikasi aktif; Laporan menunggu Fase 6; auto-backup & "Pulihkan dari Backup" menunggu Fase 7. |
...
| D-55 | Pengaturan Fase 4–5 | Sudah tersedia: nama panggilan, jam notifikasi, izin notifikasi & panduan baterai, ambang aman, target Dana Darurat, batas kunci, Blokir screenshot, Kirim backup, versi app + Mode Uji. Sisanya menyusul (Fase 7–8). |
