...
```
**Cek:** semua test lulus, terutama T-01 (hutang), T-02 (Oktober 2026 = cadangan 180rb), T-26 (gaji telat/talangan), T-33 (akhir pekan tanpa pulang).
...
```
**Cek:** onboarding + buat PIN · PIN diminta lagi setelah app ditinggal 5 menit · catat Makan dalam 4 tap · slot otomatis sesuai jam · warning muncul **sebelum** simpan · Urungkan jalan · Riwayat bisa edit/hapus · Jumat–Minggu tile Transport pindah ke depan · Senin pagi sisa jatah akhir pekan masuk Sisa.

### Fase 3 — Gaji, pemasukan, tabungan
```
Kerjakan Fase 3 di CLAUDE.md. Build rilis dan install ke HP.
```
**Cek:** input gaji tgl 29 → jadi pending, aktif tgl 1 · preview split menampilkan rumus per pos · Oktober muncul kartu kuning cadangan 180rb · gaji telat tampil sebagai talangan (bayangan) dan kembali saat gaji diinput · THR default ke Tabungan · Tabungan & Dana Darurat wajib tahan 3 detik.
...
- **Oktober 2026 kurang ±Rp 180rb** (31 hari + 5 kali Sabtu). Sisihkan dari sekarang.
